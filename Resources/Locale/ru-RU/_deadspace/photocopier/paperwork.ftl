...
paperwork-form-title-centcomm-11 = Отчёт об изменении кода угрозы
paperwork-form-title-centcomm-12 = Отчёт об актуальном меню бара и столовой
...
paperwork-form-title-centcomm-21 = Отчёт об используемых источниках питания
...
paperwork-form-title-centcomm-27 = Отчёт об используемых в интересах ресурсах
paperwork-form-title-centcomm-28 = Отчёт об артефактах
paperwork-form-title-centcomm-29 = Отчёт об аномалиях
paperwork-form-title-centcomm-30 = Отчёт об исследованных технологиях
...
paperwork-form-title-centcomm-operator-7 = Приказ о снижении выплаты
