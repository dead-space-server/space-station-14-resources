...
tts-voice-name-hogwarts_poppy_sweeting = (NEW) Поппи Добринг (Hogwarts Legacy)
tts-voice-name-hogwarts_sebastian_sallow = (NEW) Себастьян Сэллоу (Hogwarts Legacy)
tts-voice-name-hogwarts_player_female = (NEW) Игрок (Hogwarts Legacy)
tts-voice-name-hogwarts_goblin_generic_a = (NEW) Гоблин (Hogwarts Legacy)
tts-voice-name-hogwarts_player_male = (NEW) Игрок (Hogwarts Legacy)
tts-voice-name-hogwarts_natsai_onai = (NEW) Натсай Онай (Hogwarts Legacy)
tts-voice-name-hogwarts_eleazar_fig = (NEW) Элеазар Фиг (Hogwarts Legacy)
tts-voice-name-hogwarts_aesop_sharp = (NEW) Эзоп Шарп (Hogwarts Legacy)
tts-voice-name-hogwarts_ominis_gaunt = (NEW) Оминис Мракс (Hogwarts Legacy)
tts-voice-name-hogwarts_sophronia_franklin = (NEW) Софрония Франклин (Hogwarts Legacy)
tts-voice-name-hogwarts_abraham_ronen = (NEW) Абрахам Ронен (Hogwarts Legacy)
tts-voice-name-hogwarts_cuthbert_binns = (NEW) Катберт Бинс (Hogwarts Legacy)
tts-voice-name-hogwarts_lodgok = (NEW) Лодгок (Hogwarts Legacy)
tts-voice-name-hogwarts_matilda_weasley = (NEW) Матильда Уизли (Hogwarts Legacy)
tts-voice-name-hogwarts_mirabel_garlick = (NEW) Мирабель Чесноук (Hogwarts Legacy)
tts-voice-name-hogwarts_dinah_hecat = (NEW) Дина Гекат (Hogwarts Legacy)
tts-voice-name-halflife_gman = (NEW) Gman (Half-Life: Alyx)
tts-voice-name-halflife_vortigaunt = (NEW) Вортигонт (Half-Life: Alyx)
tts-voice-name-halflife_larry = (NEW) Ларри (Half-Life: Alyx)
tts-voice-name-halflife_olga = (NEW) Ольга (Half-Life: Alyx)
tts-voice-name-halflife_alyx = (NEW) Аликс (Half-Life: Alyx)
tts-voice-name-stronghold_richard = (NEW) Ричард (Stronghold Crusader)
tts-voice-name-stronghold_sultan = (NEW) Султан (Stronghold Crusader)
tts-voice-name-stronghold_emir = (NEW) Эмир (Stronghold Crusader)
tts-voice-name-stronghold_saladin = (NEW) Саладин (Stronghold Crusader)
tts-voice-name-stronghold_abbot = (NEW) Аббат (Stronghold Crusader)
tts-voice-name-stronghold_rat = (NEW) Крыса (Stronghold Crusader)
tts-voice-name-stronghold_halif = (NEW) Халиф (Stronghold Crusader)
tts-voice-name-stronghold_snake = (NEW) Змея (Stronghold Crusader)
tts-voice-name-stronghold_friedrich = (NEW) Фридрих (Stronghold Crusader)
tts-voice-name-stronghold_boar = (NEW) Кабан (Stronghold Crusader)
tts-voice-name-stalker_metro_bandit02 = (NEW) Бандит02 (Metro)
tts-voice-name-stalker_metro_degtyarev = (NEW) Дегтярёв (Metro)
tts-voice-name-stalker_metro_novice02 = (NEW) Новичок02 (Metro)
tts-voice-name-stalker_metro_pavel = (NEW) Павел (Metro)
tts-voice-name-stalker_metro_saharov = (NEW) Сахаров (Metro)
tts-voice-name-stalker_metro_soldier = (NEW) Солдат (Metro)
tts-voice-name-stalker_metro_stalker01 = (NEW) Сталкер01 (Metro)
tts-voice-name-stalker_metro_newbie01 = (NEW) Новичок01 (Metro)
tts-voice-name-warcraft_garrosh = (NEW) Гаррош (WarCraft 3)
