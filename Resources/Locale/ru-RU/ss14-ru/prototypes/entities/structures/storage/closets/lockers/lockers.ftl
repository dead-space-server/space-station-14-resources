...
ent-LockerSeniorSalvageSpecialist = снаряжение ведущего утилизатора
    .desc = { ent-LockerSalvageSpecialist.desc }
ent-LockerSeniorSalvageSpecialistFilledHardsuit = { ent-LockerSeniorSalvageSpecialist }
    .desc = { ent-LockerSalvageSpecialist.desc }
...
ent-LockerBlueShield = шкаф офицера "Синий Щит"
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerCoroner = шкаф коронера
    .desc = { ent-LockerBaseSecure.desc }
