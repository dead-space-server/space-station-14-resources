...
ent-ClothingUniformJumpsuitCargo = костюм грузчика
    .desc = Костюм для по-настоящему деловых грузчиков.
ent-ClothingUniformJumpsuitCargoformal = официальный костюм грузчика
    .desc = Официальный костюм для по-настоящему деловых грузчиков.
ent-ClothingUniformJumpsuitSalvageformal = официальный костюм утилизатора
    .desc = Официальный костюм для утилизаторов.
