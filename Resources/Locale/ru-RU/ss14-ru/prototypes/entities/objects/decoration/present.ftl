...
ent-PresentFigurine = случайная фигурка
    .desc = { ent-PresentBase.desc }
    .suffix = Заполненный, Фигурка
ent-PresentToys = случайная игрушка
    .desc = { ent-PresentBase.desc }
    .suffix = Заполненный, Игрушка
ent-PresentGame = случайная игра
    .desc = { ent-PresentBase.desc }
    .suffix = Заполненный, Игра